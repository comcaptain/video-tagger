export const screenshot_directory:string = "F:/video-tagger-data/screenshots";
export const potplayer_screenshot_directory:string = "F:/video-tagger-data/potplayer-screenshot";
export const log_directory:string = "F:/video-tagger-data/logs";
...
export const backup_directories:string[] = ["D:/backups/video-tagger", "Z:/Tony/backups/video-tagger"];
